      ...
      <div className={styles.mainCard}>
        ...
        <div className={styles.locationSection}>
          ...
          <div className={styles.infoText}>
            ...
            {floor ? <p className={styles.subValue}>{floor}</p> : null}
              ...
              <div className={styles.contactCard}>
                ...
                <a href={`tel:${contact.groom.phone}`} className={styles.phoneButton}>
                  <svg className={styles.phoneIcon} viewBox="0 0 24 24" fill="none">
                    <path
                      d="M22 16.92V19.92C22 20.52 21.52 21 20.92 21C10.38 21 2 12.62 2 2.08C2 1.48 2.48 1 3.08 1H6.08C6.68 1 7.16 1.48 7.16 2.08C7.16 3.58 7.43 5.02 7.93 6.37C8.06 6.72 7.96 7.11 7.68 7.39L5.82 9.25C7.62 12.83 11.17 16.38 14.75 18.18L16.61 16.32C16.89 16.04 17.28 15.94 17.63 16.07C18.98 16.57 20.42 16.84 21.92 16.84C22.52 16.84 23 17.32 23 17.92V20.92C23 21.52 22.52 22 21.92 22Z"
                      stroke="currentColor"
                      strokeWidth="2"
                    />
                  </svg>
