...
type AppLoginRedirectClientProps = {
  linkToken: string;
  nextPath: string;
};

function buildAppLoginLink(linkToken: string, nextPath: string) {
...
export default function AppLoginRedirectClient({
  linkToken,
  nextPath,
}: AppLoginRedirectClientProps) {
  const appLink = useMemo(() => {
    if (!linkToken) {
      return '';
    }

    return buildAppLoginLink(linkToken, nextPath);
  }, [linkToken, nextPath]);
