...
export default function SignupPage() {
  return (
    <CustomerAuthPageClient
      ...
      authTitle="고객 회원가입"
      authDescription="Google 로그인은 별도 인증 없이 바로 사용할 수 있고, 회원가입으로 만든 계정은 인증 메일 확인 후 청첩장을 생성할 수 있습니다."
      authHelperText="회원가입 후 받은 편지함의 인증 링크를 먼저 확인해 주세요. 인증 전에는 로그인은 가능하지만 새 청첩장 생성은 제한됩니다."
