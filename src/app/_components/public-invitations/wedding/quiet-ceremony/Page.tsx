...
export default function QuietCeremonyPage({ state }: WeddingThemeRendererProps) {
  ...
  return (
    ...
    >
      <div data-quiet-ceremony-section="hero">
        {heroImageUrl ? (
          <section className={styles.hero} aria-labelledby="quiet-ceremony-couple-name">
            <div className={styles.heroCopy}>
              <h1 id="quiet-ceremony-couple-name" className={styles.heroNames}>
      ...
      {invitationMessage ? (
        <section
          ...
          data-quiet-ceremony-section="invitation"
          aria-labelledby="quiet-ceremony-invitation-title"
        >
          <h2 id="quiet-ceremony-invitation-title" className={styles.heading}>
            초대의 글
          </h2>
      ...
      {contacts.length > 0 ? (
        <details
          ...
          data-quiet-ceremony-section="contact"
        >
      ...
      <section
        ...
        aria-labelledby="quiet-ceremony-schedule-title"
      >
        <h2 id="quiet-ceremony-schedule-title" className={styles.heading}>오시는 길</h2>
