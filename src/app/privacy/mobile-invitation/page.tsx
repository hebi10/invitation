...
const retentionItems = [
  ...
  '결제 검증과 중복 지급 방지에 필요한 최소한의 기록은 환불, 부정 사용 방지, 분쟁 대응을 위해 필요한 기간 동안 보관될 수 있습니다.',
