...
const steps: Record<string, ExperienceGuideStep> = {
  ...
  greeting: {
    id: 'greeting', stage: '내용 입력 · 인사말', title: '초대하는 마음을 한 문장 더해 보세요',
    description: '초대 문구와 관계 정보를 미리 채웠습니다. 실제 개인정보를 추가하지 않고도 저장과 반영 과정을 확인할 수 있습니다.',
    tasks: ['인사말 끝에 「함께해 주셔서 감사합니다.」를 추가해 보세요.', '가족 정보는 기본·가족 탭에서 확인할 수 있습니다. 「저장 후 다음」을 누르세요.'],
    action: '안내 닫고 인사말 수정',
  },
  media: {
    id: 'media', stage: '내용 입력 · 사진', title: '사진을 바꾸고 실제 디자인으로 확인해 보세요',
    description: '대표 사진과 갤러리를 미리 준비했습니다. 체험에서는 제공된 샘플 사진을 선택할 수 있습니다.',
    tasks: ['「체험용 샘플 이미지」에서 다른 사진을 선택해 대표 이미지의 변화를 확인해 보세요.', '미리보기로 배치를 확인한 뒤 닫으세요. 사진을 확인하고 「저장 후 다음」을 누르세요.'],
    action: '안내 닫고 사진 확인',
  },
  review: {
    id: 'review', stage: '내용 입력 · 공유·최종 확인', title: '입력 내용을 확인하고 저장해 주세요',
