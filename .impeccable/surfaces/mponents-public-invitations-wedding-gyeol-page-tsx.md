...
- **Direction:** `결 / GYEOL` — 화면을 이끄는 풀 포토와 한국어 에디토리얼 조판, 종이·먹색·얇은 선의 절제된 언어를 사용한다. 공개 초대장 캔버스는 최대 640px로 중앙 정렬하며, 데스크톱 히어로는 사진과 이름·일정 정보가 병렬되는 실질적 2열이고 모바일은 단일 열로 흐른다.
